package id.ac.polbeng.susisalina.intentexample3

import android.app.Activity
import android.content.Intent
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import id.ac.polbeng.susisalina.intentexample3.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSendData.setOnClickListener {
            ...
            bundle.putDouble("weight",
                binding.inputWeight.text.toString().toDouble())
            bundle.putDouble("height",
                binding.inputHeight.text.toString().toDouble())
